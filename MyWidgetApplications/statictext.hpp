...
struct StaticText : public Widget
{
    ...
    StaticText(int x, int y, std::string text, unsigned char r = 180, unsigned char g = 180, unsigned char b = 180,
               bool show_frame = false, int size_x = 150, int size_y = 25, /*sx, sy is obligatory in this case!!!*/ unsigned char frame_r = 210, unsigned char frame_g = 210, unsigned char frame_b = 210);
